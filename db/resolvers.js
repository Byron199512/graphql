...
const PersonalHospitalario=require('../models/PersonalHospitalario');
const Paciente=require('../models/Paciente');
const Turno=require('../models/Turno');
const Horario=require('../models/Horario');
const AreaMedica=require('../models/AreaMedica');
const Subprocedimiento=require('../models/Subprocedimiento');
const Procedimiento=require('../models/Procedimiento');
const AgendaQuirofano=require('../models/AgendaQuirofano');
const MedicoTratante=require('../models/MedicoTratante');
const RegistroPartos=require('../models/RegistroPartos');
const RegistroCirugiaAnestecia=require('../models/RegistroCirugiaAnestecia');
const RegistroLogs=require('../models/RegistroLogs');
...
totalLogs: (root) => {
    ...
    Mutation:{
        ...
        autenticarPersonal: async (root, { usuario, password }) => {
			...
			const passwordCorrecto = await bcryptjs.compare(password, nombreUsuario.password);
		...
		actualizarPassword: async (root, { id, usuario, password, passwordAnterior }) => {
			...
			const passwordCorrecto = await bcryptjs.compare(passwordAnterior, nombreUsuario.password);
			//si el password es incorrecto
			if (!passwordCorrecto) {
